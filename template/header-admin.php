        ...
        <ul>
            ...
            <?php if ($role === 'admin'): ?>
                <li class="<?= ($current_page == 'home') ? 'active' : '' ?>"><a href="../admin/dashboard-admin.php"><i
                            class="fas fa-home"></i> Trang chủ</a></li>
                <li class="<?= ($current_page == 'manage_teachers') ? 'active' : '' ?>"><a href="../admin/admin-manage-teachers.php"><i
                            class="fas fa-chalkboard-teacher"></i> Quản lý giáo viên</a></li>
                <li class="<?= ($current_page == 'manage_students') ? 'active' : '' ?>"><a href="../admin/admin-manage-students.php"><i
                            class="fa-solid fa-book-open-reader"></i> Quản lý học sinh</a></li>
            <?php endif; ?>
            ...
            <!-- Đăng xuất -->
            <li><a href="" id="admin-logout-btn"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a></li>
        </ul>
    </nav>
</div>